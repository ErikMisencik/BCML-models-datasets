...
with open('drake_dataset_texts_unclean.json', encoding='utf-8') as f:
    data = json.load(f)

    with open("drake_dataset_texts_clean.json", "w", encoding='ascii', errors='ignore') as k:
        k.write('[\n')
    ...
    with open("drake_dataset_texts_clean.json", "w", encoding='ascii', errors='ignore') as t:
        t.write('[\n')
